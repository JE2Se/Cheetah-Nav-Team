	...
	$.fn.zySearch = function(options,param){
		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				html += '<input id="searchInput" class="search-input" type="text" placeholder="Google镜像搜索">';
			...
			this.addEvent = function(){
				...
				document.onkeydown=function(event){
		            ...
		            if(e && e.keyCode==13){ // enter 键
		            	// 回调方法
					//	alert('123');
					var inputVal=$("#zySearch #searchInput").val();
					window.location.href="https://ug2.hub-sci.net/search?q="+inputVal;
					//window.location.href="https://googles.now.sh/search?q="+inputVal;
		            }
		        }; 
